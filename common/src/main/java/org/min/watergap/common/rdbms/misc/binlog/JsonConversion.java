                ...
                case OPAQUE:
                    ...
                    if (m_field_type == BaseLogEvent.MYSQL_TYPE_NEWDECIMAL) {
                        ...
                        if (packed_value == 0) {
                            ...
                            builder.append(':');
                            RowsLogBuffer.appendNumber2(builder, (int) ((intpart >> 6) % (1 << 6)));
                            builder.append(':');
                            RowsLogBuffer.appendNumber2(builder, (int) (intpart % (1 << 6)));
                        ...
                        if (packed_value == 0) {
                            ...
                            RowsLogBuffer.appendNumber4(builder, (int) (ym / 13));
                            builder.append('-');
                            RowsLogBuffer.appendNumber2(builder, (int) (ym % 13));
                            builder.append('-');
                            RowsLogBuffer.appendNumber2(builder, (int) (ymd % (1 << 5)));
                            builder.append(' ');
                            RowsLogBuffer.appendNumber2(builder, (int) (hms >> 12));
                            builder.append(':');
                            RowsLogBuffer.appendNumber2(builder, (int) ((hms >> 6) % (1 << 6)));
                            builder.append(':');
                            RowsLogBuffer.appendNumber2(builder, (int) (hms % (1 << 6)));
                            builder.append('.').append(RowsLogBuffer.usecondsToStr(frac, 6));
                            text = builder.toString();
                        }
                        buf.append('"').append(text).append('"');
