...
public final class RowsLogBuffer {
    ...
    protected static final Logger logger            = LogManager.getLogger(RowsLogBuffer.class);
            ...
            case BaseLogEvent.MYSQL_TYPE_JSON: {
                ...
                if (partialBits.get(1)) {
                    ...
                    if (0 == len) {
                        ...
                        int position = buffer.position();
                        JsonConversion.Json_Value jsonValue = JsonConversion.parse_value(buffer.getUint8(),
                            buffer,
                            len - 1,
                            charsetName);
                        StringBuilder builder = new StringBuilder();
