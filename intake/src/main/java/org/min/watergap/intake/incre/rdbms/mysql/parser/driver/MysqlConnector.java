package org.min.watergap.intake.incre.rdbms.mysql.parser.driver;

import org.min.watergap.intake.incre.rdbms.mysql.parser.driver.packets.HeaderPacket;
import org.min.watergap.intake.incre.rdbms.mysql.parser.driver.packets.client.AuthSwitchResponsePacket;
import org.min.watergap.intake.incre.rdbms.mysql.parser.driver.packets.client.ClientAuthenticationPacket;
import org.min.watergap.intake.incre.rdbms.mysql.parser.driver.packets.server.*;
import org.min.watergap.intake.incre.rdbms.mysql.parser.driver.socket.BioSocketChannel;
import org.min.watergap.intake.incre.rdbms.mysql.parser.driver.socket.SocketChannel;
import org.min.watergap.intake.incre.rdbms.mysql.parser.utils.MySQLPasswordEncrypter;
import org.min.watergap.intake.incre.rdbms.mysql.parser.utils.PacketManager;
...
public class MysqlConnector {
    ...
    private void negotiate(SocketChannel channel) throws IOException {
        ...
        if (handshakePacket.protocolVersion != HandshakeInitializationPacket.DEFAULT_PROTOCOL_VERSION) {
            // HandshakeV9
    ...
    private BioSocketChannel open(SocketAddress address) throws Exception {
