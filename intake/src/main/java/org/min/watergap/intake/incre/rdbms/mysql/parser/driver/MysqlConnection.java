...
import org.min.watergap.intake.incre.rdbms.mysql.parser.driver.dbsync.DirectLogFetcher;
import org.min.watergap.intake.incre.rdbms.mysql.parser.driver.packets.HeaderPacket;
import org.min.watergap.intake.incre.rdbms.mysql.parser.driver.packets.client.BinlogDumpCommandPacket;
import org.min.watergap.intake.incre.rdbms.mysql.parser.driver.packets.client.BinlogDumpGTIDCommandPacket;
import org.min.watergap.intake.incre.rdbms.mysql.parser.driver.packets.client.SemiAckCommandPacket;
import org.min.watergap.intake.incre.rdbms.mysql.parser.driver.packets.server.ResultSetPacket;
...
public class MysqlConnection {
    ...
    public void dump(String binlogfilename, Long binlogPosition, WaterGapPiping piping) throws Exception {
        ...
        MysqlIncreLogConvert convert = new MysqlIncreLogConvert();
